...
function display(markdown, config = {
    app: true,
    process: true,
    special: true,
    url: true,
    ...
    const functions = [
        ...
        {
            condition: config.url !== false,
            func: replacePhysicsUrl
        },

        {
            condition: config.app[0] !== false,
            func: replaceApps,
            param2: config.app[1]
        },

        {
            condition: config.process !== false,
            func: processMarkdown
        },

        {
            condition: config.special !== false,
            func: specialTextToUnity
        },

        {
            condition: config.project[0] !== false,
            func: replaceProjectNames,
            param2: config.project[1]
        }
